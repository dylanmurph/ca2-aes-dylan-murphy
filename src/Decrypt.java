...
public class Decrypt {
    ...
    private static String verifyKey(String fileContent) {
        ...
        while (true) {
            ...
            if (key.isEmpty()) {
                System.out.println("Error: No key provided, please try again");
                continue;
            }
            ...
            if (decryptedContent != null) {
                ...
                attempts++;
                System.out.println("Incorrect key. Attempt " + attempts + " of 3");
    ...
    private static void lockAttempt(int failures) {
        ...
        System.out.println("Too many attempts, try again in " + lockTime + " seconds");
